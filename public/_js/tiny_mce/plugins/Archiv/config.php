...
$minusDocRoot = str_replace($_SERVER['DOCUMENT_ROOT'], '', $file);
$minusJsPath = str_replace('_js/tiny_mce/plugins/Archiv/php/connector.php', '', $minusDocRoot);
$uUri = "http://".$_SERVER['HTTP_HOST'].$minusJsPath."_uploads/";
# Main settings vars
$s = array(
	# full path to upload files to and show files from
	'upload_path'			=> realpath(dirname(__FILE__).'/../../../../_uploads/'),
